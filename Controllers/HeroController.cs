...
namespace HeroApi.Controllers
{
    ...
    public class HeroController : ControllerBase
    {
        ...
        private static HeroDTO HeroToDTO(Hero model) =>
            new HeroDTO
            {
                Id = model.Id,
                SuperName = model.SuperName,
                Power = model.Power,
                BecomesVillian = model.BecomesVillian
            };
        // GET: api/Hero
        [HttpGet]
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<HeroDTO>> PostHero(Hero hero)
        {
